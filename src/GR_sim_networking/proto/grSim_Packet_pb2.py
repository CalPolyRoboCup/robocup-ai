...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x12grSim_Packet.proto\x12\rgrSim_roboCup\x1a\x14grSim_Commands.proto\x1a\x17grSim_Replacement.proto\"v\n\x0cgrSim_Packet\x12/\n\x08\x63ommands\x18\x01 \x01(\x0b\x32\x1d.grSim_roboCup.grSim_Commands\x12\x35\n\x0breplacement\x18\x02 \x01(\x0b\x32 .grSim_roboCup.grSim_Replacement')
  ,
...
_GRSIM_PACKET = _descriptor.Descriptor(
  name='grSim_Packet',
  full_name='grSim_roboCup.grSim_Packet',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='commands', full_name='grSim_roboCup.grSim_Packet.commands', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='replacement', full_name='grSim_roboCup.grSim_Packet.replacement', index=1,
...
grSim_Packet = _reflection.GeneratedProtocolMessageType('grSim_Packet', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:grSim_roboCup.grSim_Packet)
  ))
