...
from basic_skills.MoveTo.MoveTo import *
...
if __name__ == "__main__":
    game = PYsim(6)
    move_action1 = MoveTo([1000,1000], 0)
    move_action2 = MoveTo([-1000,-1000], 3.14)
    move_action3 = MoveTo([1000,-1000], 1.57)
    sequence_action_triangle = action_sequence([move_action1, move_action2, move_action3], loop = True)
    
    move_action1 = MoveTo([1000,1000], 0)
    move_action2 = MoveTo([1000,-1000], 3.14)
    move_action3 = MoveTo([-1000,-1000], 1.57)
    move_action4 = MoveTo([-1000,1000], -1.57)
    sequence_action_square = action_sequence([move_action1, move_action2, move_action3, move_action4], loop = True)
    
    move_action1 = MoveTo([2000,1000], 1.57)
    move_action2 = MoveTo([1300,0], 2.1)
    move_action3 = MoveTo([600,0], 3.4)
    move_action4 = MoveTo([-600,2000], 4.1)
    move_action5 = MoveTo([-1300,2000], 2.6)
    move_action6 = MoveTo([-2000,1000], 1.57)
    move_action7 = MoveTo([-1300,0], .86)
    move_action8 = MoveTo([-600,0], -.86)
    move_action9 = MoveTo([600,2000], -.86)
    move_action0 = MoveTo([1300,2000], .86)
